...
Agricultural dataset stored in cloud environment

Data loaded into Snowflake for warehousing

Power BI connected to Snowflake

Data modeled using relationships and measures
...
Crop-wise temperature patterns
...
✔ Dimensional breakdown (Year, Season, Crop, Location)
...
Yield variations can be associated with rainfall and humidity patterns

Location plays a major role in crop performance
...
![Dashboard Screenshot](https://github.com/Jenifarchandel/AWS-Rainfall-Analysis/blob/main/Screenshot%202026-02-04%20130356.png)
